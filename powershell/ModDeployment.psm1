...
<#
.SYNOPSIS
    Shared deployment utilities for HeadCannon mods.
.DESCRIPTION
...
.PARAMETER Dependencies
    Array of dependency DLL names to copy (default: HeadCannon.Core.dll, HeadCannon.Core.Unity.dll).
...
function Copy-ModFiles {
    ...
    param(
        ...
        [string[]]$Dependencies = @('HeadCannon.Core.dll', 'HeadCannon.Core.Unity.dll'),
