...
#include "headcannon/processing/center_offset_manager.h"
...
public:
    ...
    void SetLimits(const RotationLimits& limits) { m_limits = limits; }
    ...
    const RotationLimits& GetLimits() const { return m_limits; }
...
private:
    ...
    RotationLimits m_limits = RotationLimits::Default();
