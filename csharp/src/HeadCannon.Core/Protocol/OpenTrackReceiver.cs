...
namespace HeadCannon.Core.Protocol
{
    /// <summary>
    ...
    public sealed class OpenTrackReceiver : ITrackingDataSource, IDisposable
    {
        ...
        private const int YawOffset = 24;
        private const int PitchOffset = 32;
        private const int RollOffset = 40;
        ...
        public bool Start(int port = DefaultPort)
        {
            ...
            {
                Name = "HeadCannon-OpenTrackReceiver",
                IsBackground = true
            };
            ...
            while (_isRunning)
            {
                try
                {
                    ...
                    if (data.Length == PacketSize)
                    {
                        ...
                        {
                            _rotationPitch = (float)pitch;
                            _rotationYaw = (float)yaw;
                            _rotationRoll = (float)roll;
