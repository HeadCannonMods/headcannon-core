...
using System;
using Xunit;
using HeadCannon.Core.Config.Profiles;
using HeadCannon.Core.Processing.AxisTransform;

namespace HeadCannon.Core.Tests.Config
{
    public class ProfileSerializerTests
    {
        ...
        public void Serialize_IncludesHeader()
        {
            ...
            Assert.StartsWith("# HeadCannon Configuration Profile", result);
        }
