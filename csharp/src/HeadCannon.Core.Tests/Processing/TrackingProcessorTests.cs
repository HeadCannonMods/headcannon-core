...
namespace HeadCannon.Core.Tests.Processing
{
    public class TrackingProcessorTests
    {
        ...
        public void DefaultSettings_AreCorrect()
        {
            ...
            Assert.Equal(RotationLimits.Default, processor.Limits);
        ...
        public void Process_WithSensitivity_ScalesOutput()
        {
            var processor = new TrackingProcessor
            {
                ...
                Limits = RotationLimits.Unlimited
            };
            long timestamp = Stopwatch.GetTimestamp();
            var pose = new TrackingPose(10f, 20f, 15f, timestamp);
        ...
        [Fact]
        public void Process_WithLimits_ClampsOutput()
        {
            var processor = new TrackingProcessor
            {
                Limits = new RotationLimits(-5f, 5f, -10f, 10f, -15f, 15f)
            };
            long timestamp = Stopwatch.GetTimestamp();
            var pose = new TrackingPose(100f, -100f, 50f, timestamp);
