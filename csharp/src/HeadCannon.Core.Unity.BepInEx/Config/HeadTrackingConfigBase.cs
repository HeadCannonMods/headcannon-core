...
namespace HeadCannon.Core.Unity.BepInEx.Config
{
    /// <summary>
    ...
    public abstract class HeadTrackingConfigBase
    {
        ...
        // Constraint settings
        public ConfigEntry<float> RollMinLimit { get; private set; }
        public ConfigEntry<float> RollMaxLimit { get; private set; }
        ...
        public float CachedRollMinLimit { get; private set; }
        public float CachedRollMaxLimit { get; private set; }
        ...
        /// <summary>
        /// Default roll limit in degrees.
        /// </summary>
        protected virtual float DefaultRollLimit => 45.0f;
        ...
        public virtual void Initialize(ConfigFile config)
        {
            ...
            // Constraints section
            RollMinLimit = config.Bind(
                "Constraints",
                "RollMinLimit",
                -DefaultRollLimit,
                new ConfigDescription(
                    "Minimum roll angle limit in degrees (negative = tilt left)",
                    new AcceptableValueRange<float>(-90.0f, 0.0f)
                )
            );

            RollMaxLimit = config.Bind(
                "Constraints",
                "RollMaxLimit",
                DefaultRollLimit,
                new ConfigDescription(
                    "Maximum roll angle limit in degrees (positive = tilt right)",
        ...
        private void SubscribeToChanges()
        {
            ...
            RollMinLimit.SettingChanged += HandleSettingChanged;
            RollMaxLimit.SettingChanged += HandleSettingChanged;
        ...
        public void RefreshCache()
        {
            ...
            CachedRollMinLimit = RollMinLimit.Value;
            CachedRollMaxLimit = RollMaxLimit.Value;
