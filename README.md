...
- **Full Processing Pipeline** - Offset, deadzone, smoothing, sensitivity, and rotation limits
...
├── csharp/
│   ├── src/
│   │   ├── HeadCannon.Core/                    # Core library (multi-target)
│   │   ├── HeadCannon.Core.Unity/              # Unity extensions
│   │   ├── HeadCannon.Core.Unity.BepInEx/      # BepInEx integration
│   │   ├── HeadCannon.Core.Unity.Harmony/      # Harmony IL patching utilities
│   │   └── HeadCannon.Core.Tests/              # xUnit tests
│   └── HeadCannon.Core.sln
├── cpp/
│   ├── include/headcannon/                     # Public headers
│   ├── src/                                    # Implementation
│   ├── tests/                                  # C++ tests
│   └── CMakeLists.txt
...
| `RotationLimits` | Min/max angles per axis |
...
processor.Limits = new RotationLimits(yaw: 90f, pitch: 45f, roll: 30f);
...
BepInEx integration available via `HeadCannon.Core.Unity.BepInEx`.
...
```bash
cd csharp
dotnet build HeadCannon.Core.sln
```
...
|---------|---------|-------|
| HeadCannon.Core | net35, net40, net472, net48, netstandard2.0 | Conditional compilation for framework differences |
| HeadCannon.Core.Unity | net35, net472, net48 | Unity 2018+ Mono compatibility |
| HeadCannon.Core.Unity.BepInEx | net472, net48 | BepInEx requires .NET 4.x |
| HeadCannon.Core.Unity.Harmony | net35, net472, net48 | Harmony IL patching (via Lib.Harmony 2.2.2) |
...
### C# NuGet
- Lib.Harmony 2.2.2 (HeadCannon.Core.Unity.Harmony only)
